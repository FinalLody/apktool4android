...
public class ResFlagsAttr extends ResAttr {
    ...
    public String convertToResXmlFormat(ResScalarValue value)
        ...
        return renderFlags(ResFlagsAttrcopyOfRange(flagItems, flagsCount, flagsCount, flagItems.getClass()));
    }
    ...
    private void loadFlags() {
        ...
        mZeroFlags = ResFlagsAttrcopyOfRange(zeroFlags, zeroFlagsCount, zeroFlagsCount, zeroFlags.getClass());
        mFlags = ResFlagsAttrcopyOfRange(flags, flagsCount, flagsCount, flags.getClass());
    ...
    public static ResFlagsAttr.FlagItem[] ResFlagsAttrcopyOfRange(ResFlagsAttr.FlagItem[] original, int from, int to, Class newType) {
  	   int newLength = to - from;
  	   if (newLength < 0) throw new IllegalArgumentException(from + " > " + to);
  	 ResFlagsAttr.FlagItem[] arr = (newType == ResFlagsAttr.FlagItem[].class) ? new ResFlagsAttr.FlagItem[newLength] :
  		   (ResFlagsAttr.FlagItem[])Array.newInstance(newType.getComponentType(), newLength);
