...
public class Main {
    public static void main(String[] args)
        ...
        try {
            ...
            String cmd = args[i];
            args = (String[])copyOfRange(args, i + 1, args.length, args.getClass());
	...
	public static void main(String string, String string2, String string3) throws AndrolibException, IOException, InterruptedException {
		final String[] args = {string, string2, string3};
		main(args);
